...
async function cliqz() {
    const blue = "#0000FF";
    const white = "#FFFFFF";

    for (let i = 3; i <= 6; i++) {
        await BluetoothMatrix.draw(blue, i, 1);
    }

    await BluetoothMatrix.draw(blue, 2, 2);
    await BluetoothMatrix.draw(blue, 7, 2);
    for (let i = 3; i <= 7; i++) {
        await BluetoothMatrix.draw(blue, 1, i);
        await BluetoothMatrix.draw(blue, 8, i);
    }
    await BluetoothMatrix.draw(blue, 2, 8);
    await BluetoothMatrix.draw(blue, 7, 8);
    setTimeout(async () => {
        for (let j = 3; j <= 6; j++) {
            await BluetoothMatrix.draw(blue, j, 9);
        }
    }, 300)

    setTimeout(async () => {
        await BluetoothMatrix.draw(white, 4, 5);
        await BluetoothMatrix.draw(white, 5, 5);
        await BluetoothMatrix.draw(white, 6, 5);
        await BluetoothMatrix.draw(white, 4, 6);
        await BluetoothMatrix.draw(white, 5, 6);

    }, 300);
    setTimeout(async () => {
        await BluetoothMatrix.draw(white, 4, 7);
        await BluetoothMatrix.draw(white, 6, 7);
        await BluetoothMatrix.draw(white, 7, 8);
        await BluetoothMatrix.draw(white, 8, 9);
        await BluetoothMatrix.draw(white, 9, 10);
    }, 300);
}